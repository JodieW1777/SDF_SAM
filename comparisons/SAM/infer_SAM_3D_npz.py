...
for gt_path_file in tqdm(gt_path_files):
    ...
    for i in range(img_3D.shape[0]):
        ...
        for label_id in label_ids:
            ...
            sam_mask, _, _ = predictor.predict(point_coords=None, point_labels=None, box=bboxes1024[None, :],
    ...
    np.savez_compressed(join(seg_path, task_folder, npz_name), segs=seg_3D, gts=gt_3D,
                        spacing=spacing)  # save spacing for metric computation
